...
Analogously, $P$ has $m+r$ vertices.  Obviously, we have $m\le n$ and $q\le r$.
...
(\eqonehotb) \qquad $\left(m\atop 2\right)+\left(r\atop 2\right)$

(\eqonehotc) \qquad $\left(n\atop 2\right)+\left(q\atop 2\right)$

(\eqhclause) \qquad $|A|\cdot 3 + (nq-|A|)$

(\eqhclause) \qquad $|B| + (mr-|B|)\cdot nq$

$$
  m+r
  + \left(m\atop 2\right)+\left(r\atop 2\right)
  + \left(n\atop 2\right)+\left(q\atop 2\right)
  + |A|\cdot 3 + (nq-|A|)
  + |B| + (mr-|B|)\cdot nq
$$
