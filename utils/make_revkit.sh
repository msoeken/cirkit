...
#echo -e "\e[1;37m[I]\e[0m Deleting \e[0;32mutils/make_revkit.sh\e[0m file"
...
echo -e "\e[1;37m[I]\e[0m Deleting \e[0;32mutils\e[0m directory"
...
sed -i "25,41d" revkit-$VERSION/gui/CMakeLists.txt
