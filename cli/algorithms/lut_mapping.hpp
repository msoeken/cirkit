...
class lut_mapping_command : public cirkit::cirkit_command<lut_mapping_command, aig_t, mig_t, xmg_t, klut_t>
{
public:
  lut_mapping_command( environment::ptr& env ) : cirkit::cirkit_command<lut_mapping_command, aig_t, mig_t, xmg_t, klut_t>( env, "Performs k-LUT mapping", "apply LUT-mapping to {0}" )
  {
